model = dict(
    ...
    cls_head=dict(
        type='I3DHead',
        in_channels=512,
        num_classes=26, # changed class size
        # Changing droupout here
        # Best for general is at 0.1
        dropout=0.1),
...
ann_file = '/storage/datasets/kitti/poseview/dyadic_rem/ntu120_hrnet.pkl'
# ann_file = '/storage/datasets/kitti/poseview/original/ntu60_hrnet.pkl'
# ann_file = '/storage/datasets/kitti/poseview/original/ntu120_hrnet.pkl'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(type=dataset_type, ann_file=ann_file, split='xsub_train_2p', pipeline=train_pipeline, class_prob=class_prob)),
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/poseviewattn/only_attention_for_two_person'
